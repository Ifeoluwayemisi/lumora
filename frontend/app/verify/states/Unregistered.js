...
export default function Unregistered({ code, product, risk, aiInsights }) {
  return (
    <div className="max-w-3xl mx-auto px-4 py-20 text-center">
      <h1 className="text-4xl font-bold text-yellow-500 dark:text-yellow-400 mb-4">
        🟡 Unregistered Product
      </h1>
      <p className="text-gray-700 dark:text-gray-300 mb-6">
        The scanned code <span className="font-mono">{code}</span> is not
        registered with Lumora. Risk assessment provided below.
      </p>
