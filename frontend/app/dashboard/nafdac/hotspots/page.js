        ...
        <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 sticky top-0 z-30">
          <div className="px-4 sm:px-6 lg:px-8 py-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1">
              Geographic analysis of suspicious product scans and fake drug reports across Nigeria
            </p>
          </div>
        </div>
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="lg:col-span-2">
              {selectedStateData ? (
                <div className="space-y-6">
                  {/* State Header */}
                  <div className={`${selectedStateData.riskColor} rounded-lg p-6 border`}>
                    <h2 className="text-3xl font-bold mb-2">{selectedStateData.name}</h2>
                    <div className="grid grid-cols-3 gap-4 mt-4">
                      <div>
                        <p className="text-sm opacity-75">Suspicious Scans</p>
                        <p className="text-3xl font-bold">{selectedStateData.suspiciousScans}</p>
                      </div>
                      <div>
                        <p className="text-sm opacity-75">User Reports</p>
                        <p className="text-3xl font-bold">{selectedStateData.reportsCount}</p>
                      </div>
                      <div>
                        <p className="text-sm opacity-75">Risk Level</p>
                        <p className="text-2xl font-bold">{selectedStateData.riskLevel}</p>
                      </div>
                    </div>
                  </div>
                    ...
                    <ul className="space-y-3">
                      <li className="flex items-start gap-3">
                        ...
                        <span className="text-gray-700 dark:text-gray-300">
                          High concentration of reused codes detected in commercial areas
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-orange-600 font-bold mt-1">•</span>
                        <span className="text-gray-700 dark:text-gray-300">
                          Unusual spike in unregistered product scans in distribution centers
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-orange-600 font-bold mt-1">•</span>
                        <span className="text-gray-700 dark:text-gray-300">
                          Multiple reports from same location suggest local supply chain compromise
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800 p-6">
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-center gap-2 text-blue-900 dark:text-blue-400">
                        <span className="text-lg">→</span> Increase verification checkpoints in high-risk areas
                      </li>
                      <li className="flex items-center gap-2 text-blue-900 dark:text-blue-400">
                        <span className="text-lg">→</span> Schedule manufacturer compliance audit
                      </li>
                      <li className="flex items-center gap-2 text-blue-900 dark:text-blue-400">
                        <span className="text-lg">→</span> Issue regulatory alert to distribution networks
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-12 text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    Select a state to view hotspot intelligence and risk analysis
                  </p>
                </div>
              )}
            </div>
          ...
          <div className="mt-8 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <p className="text-gray-600 dark:text-gray-400 text-sm">Total Suspicious Scans</p>
              ...
              <div>
                <p className="text-gray-600 dark:text-gray-400 text-sm">High Risk States</p>
                <p className="text-4xl font-bold text-red-600">
                  {states.filter((s) => s.riskLevel === "High" || s.riskLevel === "Critical").length}
                </p>
              </div>
            </div>
          </div>
