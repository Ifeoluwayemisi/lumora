    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 overflow-auto">
        ...
        <div className="bg-white border-b border-gray-200 p-6">
          <h1 className="text-3xl font-bold text-gray-900">Export Analytics</h1>
        ...
        <div className="p-6 max-w-4xl">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
            ...
            <ul className="text-blue-800 text-sm mt-2 space-y-1 ml-4">
              <li>
                <strong>CSV:</strong> Spreadsheet-compatible format, perfect for
                further analysis in Excel or Google Sheets
              </li>
              <li>
                <strong>PDF:</strong> Professional report format with summaries,
