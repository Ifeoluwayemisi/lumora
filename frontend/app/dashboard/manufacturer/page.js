  ...
  if (!dashboard)
    return (
      <div className="p-4 pt-12 md:pt-16">
        <p className="text-center text-red-600 dark:text-red-400">Failed to load dashboard</p>
      </div>
    );
    ...
    <div className="p-4 pt-12 md:pt-16 pb-20 md:pb-4">
      ...
      <div className="mb-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          {/* Status Badge */}
          <div className={`px-4 py-3 rounded-xl font-semibold text-white text-center ${
            isVerified
          ...
          <div className="flex gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-yellow-800 dark:text-yellow-400 mb-3">
                Your account is under review by our NAFDAC team. You cannot generate codes yet, but you can upload additional documents to expedite the process.
              </p>
              <Link
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="p-3 rounded-lg bg-blue-100 dark:bg-blue-900/30">
              <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m0 0l8 4m-8-4v10l8 4m0-10l8-4m0 0v10l-8 4" />
              </svg>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="p-3 rounded-lg bg-red-100 dark:bg-red-900/30">
              <svg className="w-6 h-6 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4v2m0-6V7a4 4 0 118 0v6a1 1 0 11-2 0V8a2 2 0 10-4 0v6a3 3 0 11-6 0v-2m0-4V7a2 2 0 012-2h4a2 2 0 012 2v2" />
              </svg>
            </div>
          </div>
        </div>
        ...
        <div className="mb-8 p-6 rounded-xl bg-white dark:bg-gray-800 shadow-sm border border-gray-100 dark:border-gray-700">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                {quota?.used} of {quota?.limit} codes used today • {quotaRemaining} remaining
              </p>
            </div>
          ...
          <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 flex items-center justify-between">
            <div>
              ...
              <p className="text-lg font-bold text-gray-900 dark:text-white">{plan?.name || "Basic"}</p>
            </div>
            {plan?.type === "basic" && (
              <Link
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        {isVerified ? (
          <>
            <Link
              href="/dashboard/manufacturer/generate"
            ...
            >
              ...
              <h3 className="font-semibold text-gray-900 dark:text-white mb-1">Generate Codes</h3>
              <p className="text-sm text-gray-700 dark:text-gray-300">Create and download verification codes</p>
            </Link>
            ...
            >
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300">Add and update your products</p>
            </Link>
            ...
            >
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300">See AI insights and reports</p>
            </Link>
          </>
        ) : (
          <>
            ...
            >
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300">Complete verification process</p>
            </Link>
            ...
            >
              ...
              <h3 className="font-semibold text-gray-900 dark:text-white mb-1">View Status</h3>
              <p className="text-sm text-gray-700 dark:text-gray-300">Check verification progress</p>
            </Link>
            ...
            >
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300">Get help from our team</p>
            </Link>
          </>
        )}
      </div>
