...
export default function DocumentChecksPage() {
  ...
  const checkDocument = async (manufacturerId: string, documentType: string) => {
    try {
      ...
      <div className="bg-white dark:bg-gray-800 shadow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center justify-between">
            <div>
              <Link href="/dashboard/admin/security" className="text-blue-600 dark:text-blue-400 hover:underline text-sm mb-2 inline-block">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {loading ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400">Loading document checks...</p>
          </div>
        ) : (
            ...
            {documents.map((doc) => (
              <div key={doc.id} className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className={`px-4 py-2 rounded-lg ${getVerdictColor(doc.verdict)}`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  ...
                  <div className={`p-4 rounded-lg border ${
                    ...
                    <div className="flex items-center justify-between mb-2">
                      <span className="font-semibold text-gray-900 dark:text-white">Error Level Analysis</span>
                  ...
                  <div className={`p-4 rounded-lg border ${
                    ...
                    <div className="flex items-center justify-between mb-2">
                      <span className="font-semibold text-gray-900 dark:text-white">Metadata Check</span>
                      <span className={`text-sm font-bold ${
                        doc.checks.metadataResult === 'CLEAN'
                          ? 'text-green-700 dark:text-green-300'
                  ...
                  <div className="p-4 rounded-lg border border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-900/20">
                    <div className="flex items-center justify-between mb-2">
                      <span className="font-semibold text-gray-900 dark:text-white">Document Quality</span>
                  ...
                  <div className={`p-4 rounded-lg border ${
                    ...
                    <div className="flex items-center justify-between mb-2">
                      <span className="font-semibold text-gray-900 dark:text-white">Security Features</span>
                ...
                <div className="flex gap-2 pt-4 border-t border-gray-200 dark:border-gray-700">
                  ...
                  >
                    {checking === `${doc.id}-${doc.documentType}` ? 'Analyzing...' : 'Re-analyze'}
                  </button>
                  <Link
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
            <h3 className="text-lg font-bold text-blue-900 dark:text-blue-100 mb-4">Detection Methods</h3>
            <ul className="space-y-2 text-sm text-blue-800 dark:text-blue-200">
              <li><strong>ELA (Error Level Analysis):</strong> Detects compression artifacts from editing</li>
              <li><strong>Metadata Analysis:</strong> Checks for tampering in EXIF and other metadata</li>
              <li><strong>Quality Assessment:</strong> Analyzes resolution, dimensions, and format</li>
              <li><strong>Security Features:</strong> Detects holograms and authenticity marks</li>
            </ul>
          </div>

          <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6">
            <h3 className="text-lg font-bold text-green-900 dark:text-green-100 mb-4">Document Types</h3>
            <ul className="space-y-2 text-sm text-green-800 dark:text-green-200">
              <li><strong>NAFDAC License:</strong> Nigerian pharmaceutical licensing</li>
              <li><strong>Business Certificate:</strong> Corporate registration documents</li>
